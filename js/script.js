...
function encriptarCadena(traduccion){
...
function desencriptarCadena(traduccion){
    document.querySelector("#warning").removeAttribute("style");
...
enc.addEventListener( 'click', function() {encriptarCadena(traduccion);} );
des.addEventListener( 'click', function() {desencriptarCadena(traduccion);} );
